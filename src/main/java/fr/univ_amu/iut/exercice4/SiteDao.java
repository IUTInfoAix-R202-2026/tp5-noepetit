...
public class SiteDao {
  ...
  public void insert(Site site) {
    ...
    try (Connection connexion = source.getConnection();
      ...
      throw new DataAccessException("impossible d'inserer", e);
    }
  }
  ...
  public void update(Site site) {
    ...
    try (Connection connexion = source.getConnection();
      ...
      throw new DataAccessException("impossible MAJ d'inserer", e);
    }
  }
  ...
  public void delete(String numeroCarre) {
    ...
    try (Connection connexion = source.getConnection();
      ...
      throw new DataAccessException("impossible de supprimer", e);
    }
  }
